...
import { PRODUCTION_TIME_SCALING, PRODUCE_ONE_CLICK, SOUND_VOLUME, PRODUCE_IN_MANAGEMENT, PRODUCE_PARTS, ON_LOCAL_MACHINE} from './Constants.js';
...
class WorkshopDialogue extends DialogueScene
{
    ...
    create()
    {
         ...
         */
        this.progressText = new Phaser.GameObjects.Text(this,this.producingText.x, this.producingText.y+45,'Progress:', {fontSize:18,color: '#000'}).setOrigin(0,0.3);
        /**
         * Text that describers the [AvailableTimeBar]{@link WorkshopDialogue#availableBar}.
         */
        this.availableTimeText = new Phaser.GameObjects.Text(this,this.producingText.x, this.progressText.y+45, 'Available time:',{fontSize:18,color: '#000'}).setOrigin(0,0.3);
        /**
         * Text that describes the [Queue]{@link WorkshopDialogue#workshopQueue}.
         */
        this.nextText = new Phaser.GameObjects.Text(this,this.producingText.x, this.availableTimeText.y+30,'Next:', {fontSize:18,color: '#000'}).setOrigin(0,0.3);
        /**
    ...
    update()
    {
        ...
        this.availableBar.value = this.workshop.availableHours + ' Hours';
        ...
        if (this.workshop.timer && this.workshop.timer.elapsed != this.workshop.timer.delay)
        {
            ...
            this.producingText.text = 'Produced: ';
            if (!ON_LOCAL_MACHINE){
                this.workshop.controllTimer.updateTime()
                if (this.workshop.timer.elapsed < this.workshop.controllTimer.elapsed){
                    this.workshop.timer.elapsed = this.workshop.controllTimer.elapsed
                } 
            }
            this.workProgress.setMeterPercentage(this.workshop.timer.elapsed/this.workshop.timer.delay);
            this.workProgress.value = 'Duration: ' + Math.ceil(((this.workshop.timer.delay - this.workshop.timer.elapsed)/1000)/PRODUCTION_TIME_SCALING);
        }
        else
        {
            ...
            this.producingText.text = 'Produced: Nothing.';
        }
    }
    ...
    addProduceButtons()
    {
                ...
                'button-square-unpressed','button-square',this.workshop.items[0].imageCode,function()
            {
                ...
                if (canAfford.status == true)
                {
                    ...
                    this.buttonLeft.showMessage('Will be built!');
                ...
                'button-square-unpressed','button-square',this.workshop.items[1].imageCode,function()
            {
                ...
                if (canAfford.status == true)
                {
                    ...
                    this.buttonRight.showMessage('Will be built!');
    ...
    addCostsContainer(x,y, item)
    {
        ...
        let costHeader = new Phaser.GameObjects.Text(this, 0,0, 'Cost', {fontSize:18,color: '#000'}).setOrigin(0,0.3);
        ...
        let timeText = new Phaser.GameObjects.Text(this, 0,metalText.y+20, costHours+ ' h.',{fontSize:18,color: '#000'}).setOrigin(0,0.3);
