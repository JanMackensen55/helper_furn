 ...
 * @param {Number} data.height defines the height of the panel.
...
class Panel extends Phaser.GameObjects.Container
{
    constructor(data)
    {
        ...
        let contents = new Phaser.GameObjects.Sprite(scene, -1,-5, 'panel-contents');
        ...
        let headerText = new Phaser.GameObjects.Text(scene, panel.x, contents.y-contents.displayHeight/2, header, {fontSize:24,color: '#000'}).setOrigin(0.5, -0.8);
