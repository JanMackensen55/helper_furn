 ...
 * every dialogue. As an example: this class is extended for every dialogue that is launched if a building is clicked.
 * @class DialogueScene
...
class DialogueScene extends Phaser.Scene
{
    ...
    init(data){
        ...
        /**
         * The EventDispatcher to monitor that a dialogue has been closed by the player
    ...
    close()
    {
        ...
        this.scene.manager.keys.ui.input.enabled = true;
        this.emitter.emit('dialogueClosed', this.sceneName);
        this.tweens.add(
            {
                targets: this.panel,
                scale: 0,
