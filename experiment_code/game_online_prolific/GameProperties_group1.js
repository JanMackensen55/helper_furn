...
/**
 * This constant determines from which subset of months the months
 * are selected in the experiment. If this constant is undefined,
 * the experiment will select from all 12 months.
 */
export const MONTH_SUBSET = [0, 1, 2, 3, 4, 10];
...
/**
 * Maximum number of months that can exist
 */
...
*/
 export const PRODUCE_ONE_CLICK = true;
...
/**
 * Specifies whether a text should be written or not during self assement.
 */
  export const ASSESMENT_TEXT = false
...
/**
 * Specifies whether the diagram or medals are displayed as
 * feedback in the newspaper.
 * 
 * @name module:GameProperties#MEDAL_FEEDBACK
 */
export const MEDAL_FEEDBACK = true;
 ...
 */
 export const FEEDBACK_PERFECT = 'Perfect!';

/**
 * The text for a very good solution
 * @name module:GameProperties#FEEDBACK_VERY_GOOD
 */
export const FEEDBACK_VERY_GOOD = 'Very good!';
/**
 ...
 */
export const FEEDBACK_GOOD = 'Not bad!';
/**
 ...
 */
export const PERCENTAGE_GOOD = 0.90;
 ...
 */
export const FEEDBACK_LOW = 'You can do better!';
...
export const SOSCI_PLAYER_TIME_VAR = 'PT01';
  ...
  */
 export const SOSCI_ASSESSMENT = 'AS01';
 ...
 /**
  * The variable where the Experiment Order is saved
  */
 export const SOSCI_ORDER = 'EO01'

/**
 * The variable where Controll Questions are saved
 */
export const SOSCI_CONTROLL_QUESTIONS = 'CQ01'
