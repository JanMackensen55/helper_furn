...
class MainScene extends Phaser.Scene 
{
    ...
    preload()
    {
        ...
        this.load.image('card_background', 'card_background.png');
        ...
        this.load.image('numberPanel', "grey.png")
    ...
    create()
    {
        ...
        this.multipleChoice = new MultipleChoice({
            scene: this,
            x: 400*Constants.SCALINGX,
            y: 500*Constants.SCALINGY,
            scalingX: Constants.SCALINGX,
            scalingY: Constants.SCALINGY,
            cards: this.cards
        })
