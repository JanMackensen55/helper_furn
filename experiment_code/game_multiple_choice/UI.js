...
class UI extends Phaser.GameObjects.Container {
    constructor(data){
        ...
        let panel = new Phaser.GameObjects.Sprite(scene, 580*scalingX, 30*scalingY, 'panel_beige').setOrigin(0,0).setScale(scalingX, scalingY);
        panel.displayHeight = 370*scalingY;
