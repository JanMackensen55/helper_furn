 ...
 * @param {Array} data.lpSolution the optimal solutions
...
class FeedbackSummary extends Phaser.GameObjects.Container
{
    constructor(data)
    {
        ...
        month = month -1;
        let ownText = new Phaser.GameObjects.Text(scene, -190,-110, 'Deine Lösung:', {fontSize: 15, color: '#000'}).setOrigin(0,0.5);
        // Player Values
        ...
        this.optimalText.text = 'Meine Lösung:';
