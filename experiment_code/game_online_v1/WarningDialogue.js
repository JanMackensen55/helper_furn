...
class WarningDialogue extends InteractionScene
{
    ...
    create()
    {
        ...
        let buttonNo = new Button(this, -100, 50, "button-long", "button-long-pressed", "Nein", this.handelResponse.bind(this,false),this);
        let buttonYes = new Button(this, 100, buttonNo.y, "button-long", "button-long-pressed", "Ja", this.handelResponse.bind(this,true),this);
